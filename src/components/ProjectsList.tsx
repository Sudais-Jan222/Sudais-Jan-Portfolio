            ...
            {projectsData.map((project, index) => {
              ...
              return (
                <Link to={`/projects/${project.slug}`} key={index} style={{ textDecoration: 'none', color: 'inherit', display: 'flex' }}>
                  <div style={{ width: "100%", padding: "40px", backgroundColor: "#111", border: "1px solid #363636", borderRadius: "20px", display: "flex", flexDirection: "column", gap: "30px", transition: "transform 0.3s ease, borderColor 0.3s ease", cursor: "pointer", flex: 1 }} 
                       onMouseEnter={(e) => { e.currentTarget.style.transform = "translateY(-10px)"; e.currentTarget.style.borderColor = "var(--accentColor)"; }}
                       onMouseLeave={(e) => { e.currentTarget.style.transform = "translateY(0px)"; e.currentTarget.style.borderColor = "#363636"; }}>
                    ...
                    <div style={{ width: "100%", height: "250px", borderRadius: "12px", overflow: "hidden", backgroundColor: "#000" }}>
